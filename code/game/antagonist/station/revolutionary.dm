...
/datum/antagonist/revolutionary
	...
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/captain, /datum/job/hos, /datum/job/chief_engineer, /datum/job/achief_engineer, /datum/job/cmo, /datum/job/acmo, /datum/job/rd, /datum/job/ard, /datum/job/ethicsliaison, /datum/job/tribunal, /datum/job/commsofficer, /datum/job/securityguard, /datum/job/securitysergeant, /datum/job/securitylieutenant, /datum/job/goirep, /datum/job/raisa)
