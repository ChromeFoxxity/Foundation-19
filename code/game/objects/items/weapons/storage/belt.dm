...
/obj/item/storage/belt/holster/security/tactical/fullseccap/New()
	..()
	new /obj/item/reagent_containers/spray/pepper(src)
	new /obj/item/device/flash(src)
	new /obj/item/device/flashlight/maglight(src)
	new /obj/item/grenade/flashbang(src)
	new /obj/item/gun/projectile/revolver/military/heavy(src)
	new /obj/item/ammo_magazine/speedloader/heavy(src)
	new /obj/item/ammo_magazine/speedloader/heavy(src)
	new /obj/item/ammo_magazine/box/a454(src)
	new /obj/item/handcuffs(src)
	new /obj/item/melee/baton/loaded(src)
	update_icon()

/obj/item/storage/belt/holster/security/tactical/fullseclt/New()
	..()
	new /obj/item/reagent_containers/spray/pepper(src)
	new /obj/item/device/flash(src)
	new /obj/item/device/flashlight/maglight(src)
