...
/obj/item/device/radio/headset/scp/uiu
	name = "UIU headset"
	desc = "The headset for an official of the Unusual Incidents Unit."
	icon_state = "uiu_headset"
	ks1type = /obj/item/device/encryptionkey/uiu

/obj/item/device/radio/headset/scp/uiu/alt
	name = "UIU headset"
	desc = "The headset for an elite task force of the Unusual Incidents Unit."
	icon_state = "uiu_headset_alt"

/obj/item/device/radio/headset/scp/uiu/representative
	name = "UIU representative's headset"
	desc = "The headset for a representative of the Unusual Incidents Unit."
	ks2type = /obj/item/device/encryptionkey/headset_com

//##
//GROUPS OF INTEREST ENCRYPTION KEYS
//##
...
/obj/item/device/encryptionkey/uiu
	name = "UIU radio encryption key"
	icon_state = "uiu_cypherkey"
	channels = list("UIU" = 1)
